"""offlinectl — Air-gap bundle orchestrator CLI entrypoint."""
...
def version_callback(value: bool) -> None:
    if value:
        console.print(f"offlinectl {__version__}")
        raise typer.Exit()
...
def main(
    ...
    """offlinectl — air-gap bundle orchestrator for Linux environments."""
